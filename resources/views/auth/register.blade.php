        ...
        <div class="card-content">
          ...
          <form action="{{route('register')}}" method="post">
            ...
            <div class="field">
              ...
              <p class="control">
                <input class="input $errors->has('name') ? 'is-danger' : ''}}" type="text" name="name" id="name" placeholder="Your name" required/>
              </p>
              @if ($errors->has('email'))
            ...
            <button type="submit" name="button" class="button is-primary is-outlined is-fullwidth m-t-20">Register</button>
          </form>
